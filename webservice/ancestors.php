...
/**
 * Web Service Wrapper for Geoplanet getAncestors (demonstration)
 * Add woeid to 'woeid' parameter (default format is json; use 'format=serialized' for php)
 * @example http://example.com/gplplanet/webservice/ancestors.php?woeid=12345
 * @package gplplanet
