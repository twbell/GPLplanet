...
/**
 * Web Service Wrapper for Geoplanet getChildren (demonstration)
 * Add woeid to 'woeid'parameter (default format is json; use 'format=serialized for php)
 * @example http://example.com/gplplanet/webservice/children.php?woeid=12345
 * @package gplplanet
